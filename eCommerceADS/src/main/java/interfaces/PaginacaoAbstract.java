...
/**
 * Responsável por fazer a paginação da consulta.
 * 
 * @author Victor
 */
public abstract class PaginacaoAbstract implements Serializable {
    ...
    public void setTotalReg(int totalReg) {
        ...
        cacularTotalDePaginas();
    }

    private void cacularTotalDePaginas() {
        BigDecimal tmp = new BigDecimal(totalReg);
//        totalPaginas = totalReg / tamanhoPagina;
